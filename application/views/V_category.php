...
<html lang="en">
    ...
    <head>
        <title>Category - surat municipal corporation complaint system</title>
                                ...
                                <div class="btn-group" style="float: right;">
                                    ...
                                    <div class="dropdown-menu dd">
                                        ...
                                        <div class="profile-block">
                                            <div class="row">
                                                <div class="">
                                                    <div class="col-xs-12"><a href="<?php echo site_url('C_category/add_new_category'); ?>" class="col-xs-12">Add New Category</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <tfoot>
                                                    ...
                                                    foreach ($cat_info as $v_cat_info) {
                                                        ...
                                                        <tr class="text-center">
                                                            <td><?php echo $v_cat_info->cmp_id; ?></td>
                                                            <td><?php echo $v_cat_info->cmp_type; ?></td>
                                                            <td>
                                                                <?php
                                                                if ($v_cat_info->is_active == 1) {
                                                                    echo "Active";
                                                                } else {
                                                                    echo "Deactive";
                                                                }
                                                                        ...
                                                                        <div class="profile-block">
                                                                            <div class="row">
                                                                                <div class="">
                                                                                    ...
                                                                                    if ($v_cat_info->is_active == 1) {
                                                                                        ?>
                                                                                        <div class="col-xs-12"><a href="<?php echo site_url('C_category/status_category/') . $v_cat_info->cmp_id; ?>/0" class="col-xs-12">Deactive</a></div>
                                                                                        <?php
                                                                                    } else {
                                                                                        ?>
                                                                                        <div class="col-xs-12"><a href="<?php echo site_url('C_category/status_category/') . $v_cat_info->cmp_id; ?>/1" class="col-xs-12">Active</a></div>
                                                                                        <?php
                                                                                    }
                                                                                    ?>
                                                                                    <div class="col-xs-12"><a href="<?php echo site_url('C_category/add_new_category/') . $v_cat_info->cmp_id; ?>" class="col-xs-12" onclick="">Edit</a></div>
                                                                                    <div class="col-xs-12"><a href="<?php echo site_url('C_category/delete_category/') . $v_cat_info->cmp_id; ?>" class="col-xs-12" onclick="confirm('Are you sure !!!')">Delete</a></div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
