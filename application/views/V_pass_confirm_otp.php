...
<head>
    <title>Confirm Password - surat municipal corporation complaint system</title>

    <meta charset="utf-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="author" content="surat municipal corporation complaint system">
    <meta name="keywords" content="Confirm password, Second time password, Re-password, password, Enter second time password, Same password, again password, Second time password, smccs, smc, Surat, complaint, corporations, surat municipal corporations, surat municipal corporation complaint system, online payment, shops &amp; gujarat, india, asia, e-governance, information technology">
            ...
            <section class="inner-section">
                ...
                <div class="row form" id="dvUSignup">
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <form Id="" action="<?php echo site_url("C_forgot_passwd/submit_pass_otp"); ?>" method="post" enctype="multipart/form-data">
                            <div class="alert alert-info"><strong>Note:</strong><?php if (!empty($Errotp)) {
                                                                                    echo $Errotp;
                                                                                } ?></div>
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input autocomplete="off" class="form-control" maxlength="50" name="txtotp" type="number" value="" />
